...
#define HAL_KEY_SW_7_IENBIT   BV(0) /* Mask bit for all of Port_1 */
#define HAL_KEY_SW_7_ICTL     P1IEN /* Port Interrupt Control register */
#define HAL_KEY_SW_7_ICTLBIT  BV(2) /* P1IEN - P1.2 enable/disable bit */
...
#define HAL_KEY_SW_8_IENBIT   BV(0) /* Mask bit for all of Port_1 */
#define HAL_KEY_SW_8_ICTL     P1IEN /* Port Interrupt Control register */
#define HAL_KEY_SW_8_ICTLBIT  BV(3) /* P1IEN - P1.3 enable/disable bit */
...
void HalKeyInit( void )
{
  ...
  P0INP &= ~(HAL_KEY_SW_6_BIT);               /* Enable pullup for P0_1 */
...
void HalKeyPoll (void)
{
  ...
  /* Add S1 button detection */
  if (HAL_PUSH_BUTTON1())
  {
    keys |= HAL_KEY_SW_6;
  }

  /* Add S2 button detection (P1_2) - 恢复检测 */
  if (HAL_PUSH_BUTTON3())
  {
    keys |= HAL_KEY_SW_7;
  }

  /* Add S3 button detection (P1_3) - 恢复检测 */
  if (HAL_PUSH_BUTTON4())
  {
    keys |= HAL_KEY_SW_8;
  }
  ...
  /* Invoke Callback if keys changed */
